...
class PaymentTransaction(models.Model):
    ...
    def _get_tx_from_notification_data(self, provider_code, notification_data):
        ...
        tx = self.search([('provider_reference', '=', str(merchand_id)), ('provider_code', '=', 'mercado_pago_qr')])
        if not tx:
            raise ValidationError( _(
                "No transaction found matching reference %s.", notification_data.get('id')
            ))
        return tx
    ...
    def mp_payment_order_create(self):
        ...
        resp = mercado_pago.call_mercado_pago("put", f"/instore/qr/seller/collectors/{self.provider_id.mp_user_id}/stores/{self.provider_id.mp_external_store_id}/pos/{self.provider_id.mp_external_pos_id}/orders", data)
    ...
    def mp_payment_order_get(self):
        ...
        resp = mercado_pago.call_mercado_pago("get", f"/merchant_orders/?external_reference={self.reference}", {})
    ...
    def mp_payment_order_cancel(self):
        mercado_pago = MercadoPagoRequest(self.provider_id.mercado_pago_qr_access_token)
        resp = mercado_pago.call_mercado_pago("delete", f"/instore/qr/seller/collectors/{self.provider_id.mp_user_id}/pos/{self.provider_id.mp_external_pos_id}/orders", {})
